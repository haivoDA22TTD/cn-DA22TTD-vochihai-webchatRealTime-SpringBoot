...
import haivo.chatapp.server.dto.MessageContentDTO;
...
public class MessageContentMapper {
    ...
    public MessageContentDTO toDTO(final MessageContent messageContent,
    ...
    public MessageContent toEntity(final MessageContentDTO messageContentDTO,
